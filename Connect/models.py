...
class UserDatabase(models.Model):
    ...
    website=models.CharField(max_length=130, null=True,blank=True)
    experience = models.CharField(max_length=130, null=True, blank=True)
    company = models.CharField(max_length=130, null=True, blank=True)
    profile_title = models.CharField(max_length=130, null=True, blank=True)
